...
function parse(input: string, zone = 'UTC', locale?: Intl.LocalesArgument) {
...
describe('parseNaturalDate', () => {
  ...
  it('uses IANA zones and preserves timezone-aware clock values', () => {
    expect(parse('tomorrow 9:30am', 'America/New_York')).toBe('2026-04-16T09:30-04:00')
    expect(parse('tomorrow 9:30am America/New_York')).toBe('2026-04-16T13:30+00:00')
    expect(parse('march 8 2026 3:30am', 'America/New_York')).toBe('2026-03-08T03:30-04:00')
  })
